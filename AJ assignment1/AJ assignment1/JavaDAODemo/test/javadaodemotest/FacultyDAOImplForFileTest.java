...
import javadaodemo.FacultyDAOImplForFile;
 ...
 * @author User
 */
public class FacultyDAOImplForFileTest {
    ...
    public FacultyDAOImplForFileTest() {
    }
    
    @BeforeClass
    public static void setUpClass() {
    facultyDataAccessObject = new FacultyDAOImplForFile();
    }
    ...
    @Test
    public void testGetFacultyByInitial() {  
