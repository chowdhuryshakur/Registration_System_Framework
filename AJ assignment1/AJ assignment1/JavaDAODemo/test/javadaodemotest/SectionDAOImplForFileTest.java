...
import javadaodemo.SectionDAOImplForFile;
 ...
 * @author User
 */
public class SectionDAOImplForFileTest {
    ...
    public SectionDAOImplForFileTest() {
    }
    
    @BeforeClass
    public static void setUpClass() {
    sectionDataAccessObject = new SectionDAOImplForFile();
    }
    ...
    public void testGetSectionBySecId() {  
        sectionDataAccessObject.insert(section);  
